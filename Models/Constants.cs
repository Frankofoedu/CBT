...
namespace rating.Data
{
    public static class Constants
    {
        ...
        public static readonly string allUserFolderPath = Path.Combine(folderPath, "AllUsers");


        public static readonly string userPath = Path.Combine(userFolderPath, "users.json");
        public static readonly string allUserPath = Path.Combine(allUserFolderPath, "Allusers.json");
        ...
        public static Dictionary<string, List<string>> ListCentres = new Dictionary<string, List<string>>()
        {
            ...
            {"OGIDI ZONE", new List<string>{ "CAVE CITY SECONDARY SCHOOL OGBUNIKE", "NEW ERA SECONDARY SCHOOL NTEJE", "MATER AMABILIS SECONDARY SCHOOL UMUOJI", "GIRLS HIGH SCHOOL ALOR", "URBAN SECONDARY SCHOOL NKPOR", "OUR LADIES SECONDARY SCHOOL NNOBI", "ANGLICAN GIRLS SECONDARY SCHOOL OGIDI" } },
